 ...
 */
function initialize(apiKey, appName, regionId, clientId, uuid, callback) {
  Engage.initialize(apiKey, appName, regionId, clientId, uuid, callback)
}
...
function isUserRegistered(callback) {
  Engage.isUserRegistered(callback);
}
